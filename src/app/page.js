...
const HomePage = () => {
  ...
  useEffect(() => {
    // Dynamically generate media files instead of hardcoding them
    const mediaCount = 33; // Number of media files available
  ...
  return (
    <div className="min-h-screen bg-white px-40 pt-20">
      <h1 className="text-7xl font-sans text-center text-gray-800 mb-12">An Ending Of Things</h1>
